...
Calibration information is displayed at the start of the program: 
* In the start-up message : 
    - Screen area corresponding to the full tablet (also displayed in green on screen)
    - Tablet area corresponding to full screen 
* The size of the tablet is displayed in green on the screen when the program starts.
