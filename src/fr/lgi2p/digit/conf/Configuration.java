...
public class Configuration {
	...
	public void setIndexOfDifficulty(double indexOfDifficulty) {
	    // we shall change the internal circle to be as close as possible to the requested ID 
	...
	if (cursorSizeOS.height < CursorDiameter) {
	    ...
	    System.out.println( "Closest possible cursor size for this system is " + cursorSizeOS.width + "x" + cursorSizeOS.height  );			  
	}

	// create an image with a transparent background + a circle with hotspot in the middle
	// TYPE_INT_ARGB to allow transparency 
	BufferedImage bufferedImage = new BufferedImage(cursorSizeOS.height, cursorSizeOS.height, BufferedImage.TYPE_INT_ARGB);
	...
	System.out.println("cornerX = " + this.getCornerX() + ", centerX = " + centerX + ", externalRadius =" + this.getExternalRadius() );
    }
    public void setCenterY(int centerY) {
	this.centerY = centerY;
	this.cornerY = centerY - externalRadius;  // set the corner as well
	System.out.println("cornerY = " + this.getCornerY() + ", centerY = " + centerY + ", externalRadius =" + this.getExternalRadius() );
    }
