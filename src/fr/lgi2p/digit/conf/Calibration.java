...
public class Calibration {
    ...
    // We want a part of the tablet to be mapped to a part of the screen.
    ...
    public void setScreenCalibration(JFrame window) {
        ...
        int screenResolution_ppi = java.awt.Toolkit.getDefaultToolkit().getScreenResolution();
        double mm2px = (double) screenResolution_ppi / 25.4;
        configuration.setMm2px(mm2px);
    ...
    public void toWindow() {
        ...
        String txt = "Calibration "
                ...
                + ";tablet: " + tabletSize_px.width + " x " + tabletSize_px.height + " (pixels)"
                ...
                // + ";  ---------- "
                // + ";newTabletTop = " + newTabletTop + ";newTabletLeft = " + newTabletLeft
                // + ";newTabletBottom = " + newTabletBottom + ";newTabletRight =  " + newTabletRight
                // + ";new_tabletSize_px = " + (newTabletRight - newTabletLeft) + " x " + (newTabletBottom - newTabletTop)
                // + " (pixels)" + "ratio = "
                // + ((newTabletRight - newTabletLeft) / (double) (newTabletBottom - newTabletTop))
